...
class DCGAN:
    def __init__(self, channels=3, batchsize=50, noise_dim=100, feature_dim=10):
        ...
        self.discriminator = Discriminator(feature_dim=feature_dim).to(self.device) #removed channels, may need to add back
        ...
        self.optimiser_D = optim.Adam(self.discriminator.parameters(), lr=0.002, betas=(0.5, 0.999))

        self.loss = nn.BCELoss()

    def train(self, data_loader, epochs, sample_interval=20):
